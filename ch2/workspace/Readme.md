...
- srvcli_py: a node to demonstrate client-server communication

## Example 3: Action server/client
- action_pkg: define an interface for action communication
- linear_motor_control_action: a node implementing action server and client